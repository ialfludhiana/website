...
export const metadata = {
  title: "DELF DALF French Preparation Ludhiana | IALF Immigration",
  description:
    "Expert DELF and DALF preparation in Ludhiana at IALF Immigration. CEFR-focused coaching to achieve B1, B2, C1, or C2 French certification for study and immigration.",
